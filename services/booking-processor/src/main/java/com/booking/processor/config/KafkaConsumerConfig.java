...
import com.booking.processor.consumer.BookingCreatedEvent;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, BookingCreatedEvent> consumerFactory() {
        ...
        config.put(JsonDeserializer.TRUSTED_PACKAGES, "com.booking.processor.consumer");
    ...
    public ConcurrentKafkaListenerContainerFactory<String, BookingCreatedEvent> kafkaListenerContainerFactory(
        ...
        factory.getContainerProperties().setAckMode(
                org.springframework.kafka.listener.ContainerProperties.AckMode.RECORD); // Acknowledgement mode - record by record
        return factory;
    }
}
